...
CREATE TABLE `operatorActive` (
   ...
   `description` LONGTEXT COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '活动说明',
   ...
   `sort` INT(5) DEFAULT NULL DEFAULT '0' COMMENT '排序',
   `title` LONGTEXT COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '活动标题',
