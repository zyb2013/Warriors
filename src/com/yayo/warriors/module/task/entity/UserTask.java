...
@Entity
@Table(name = "userTask")
public class UserTask extends BaseModel<Long> {
	private static final long serialVersionUID = 1293374849897784001L;
	...
	public static UserTask valueOf(long playerId, int chain) {
	...
	public String toString() {
		return "UserTask [id=" + id + ", chain=" + chain + ", taskId=" + taskId + ", status="
				+ status + ", taskEvent=" + taskEvent + "]";
	}
