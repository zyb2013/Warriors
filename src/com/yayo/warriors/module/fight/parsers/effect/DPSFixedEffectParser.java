 ...
 */
@Component
public class DPSFixedEffectParser extends AbstractSkillEffectParser {
	
	
	protected int getType() {
		return SkillEffectType.DPS_FIXED_EFFECT.getCode();
	}
	...
	public void parser(Context context, FightAttribute attacker, 
		...
		boolean knockFlyDefense = targeter.isKnockFlyDefense();
		...
		int skillEffectDamageValue = Math.max(FightRule.MIN_FIGHT_DAMAGE, damageValue + skillDamage + baseDamage);
