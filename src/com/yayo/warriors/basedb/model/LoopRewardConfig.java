...
public class LoopRewardConfig {
	...
	public List<RewardVO> getRewardList() {
		...
		synchronized (this) {
			...
			for (String[] element : arrays) {
				...
				if(element.length < 2 || Integer.valueOf(element[1]) < 1) {
	...
	public String toString() {
		return "LoopRewardConfig [id=" + id + ", expExpr=" + expExpr + ", gasExpr=" 
